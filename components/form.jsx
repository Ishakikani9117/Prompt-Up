  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
       ...
       >
        ...
        <label> 
           <span className="font-satoshi font-semibold text-base text-gray-700"
           >Tag {` `}<span className="font-normal" >(#design, #software, #Analysis)</span> </span>
           <input
             value={post.tag}
             onChange={(e) => setpost({
              ...post,
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          <button 
            type="submit"
            disabled={submitting} //if currently submitting, then button is disabled
